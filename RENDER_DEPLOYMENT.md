...
- **Type**: Web Service
- **Environment**: Node
- **Root Directory**: `backend` ⚠️ **IMPORTANT**: Set this in Render dashboard
...
- **Root Directory**: `ml-service` ⚠️ **IMPORTANT**: Set this in Render dashboard
...
- **Type**: Static Site
- **Root Directory**: `frontend` ⚠️ **IMPORTANT**: Set this in Render dashboard
- **Build Command**: `npm install && npm run build`
